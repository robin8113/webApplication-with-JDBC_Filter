...
<table class="table table-condensed table-dark table-hover ">
 ...
 <%  for(Product ps : p){ %>
   <tr>
     ...
     <button type="submit" name="edit" value="edit" style="background-color: DodgerBlue;border:none;" ><i class="fa fa-edit" ></i></button>
     </form></td>
     <td>
     
     <form method="post" action="${pageContext.request.contextPath}/DeleteProduct">
     <input type="text" hidden="hidden" name="pid" value="<%= ps.getPid() %>">
     <button type="submit" name="" value="delete" style="background-color: DodgerBlue;border:none;" ><i class="fa fa-trash"  ></i></button>
     </form>
     </td>
